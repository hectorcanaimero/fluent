# Las reglas del juego · Fluent

Bienvenido al grupo. Aquí practicamos idiomas como si fuera un juego: ganando XP, subiendo en el ranking semanal, manteniendo rachas y ayudándonos unos a otros con desafíos.
...
A medida que acumulas XP, subes de nivel. No cambian tu experiencia, solo te muestran dónde estás:
...
Tenés un día de gracia por semana (de lunes a domingo). Si una semana no practicás un día, la gracia automáticamente salva tu racha esa vez. Solo funciona una vez por semana, así que usalo sabiamente.

## Desafíos cruzados

En la sección "Desafíos", podés ver qué temas practicaron tus compañeros últimamente. Si te animas, podés aceptar el desafío de practicar el mismo tema que ellos. Condiciones:
...
Cada semana, el grupo compite por quién acumula más XP. La semana empieza los lunes a las 00:00 UTC (o un poco después, según tu zona horaria).

**Empates:** si dos personas tienen el mismo XP, gana quien completó más sesiones esa semana.

## La racha del grupo

Además de tu racha personal, el grupo también tiene una. Cuenta cuántos días seguidos **todos los miembros activos** completaron al menos una sesión. Un miembro "activo" es alguien que:
- Está onboarded (ya empezó a usar la app).
- Practicó al menos una sesión válida en los últimos 14 días.

Así, un amigo que se tomó unas vacaciones largas no bloquea la racha grupal.

## Qué ven tus compañeros de vos

Para mantener tu privacidad, tus compañeros **solo ven**:
- Tu nombre.
- Tu nivel (Chatterbox, Storyteller, etc.).
- Tu XP total.
- Tu racha actual.
- El último día que practicaste.
- Los temas de tus sesiones recientes (solo los nombres: "Viajes", "Tecnología", etc.).

**Nunca ven:**
- Tus conversaciones ni turnos.
- Tus correcciones.
- Lo que el tutor recuerda de vos.
- Tu historial completo de temas.

## Sesión válida: qué cuenta y qué no
...
¿Preguntas sobre tu XP, tu racha o un desafío? Consultalas en el grupo.
