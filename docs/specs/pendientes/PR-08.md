# Pendientes y decisiones sin spec — PR-08

Entradas registradas por la sesión de PR-08. Se revisan al cerrar la fase y se incorporan a la spec o se revierten.
